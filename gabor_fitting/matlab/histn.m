function [h,hn,xspan]=histn(data,x0,binsize,xf,colorname)
...
bar(xspan,hn,'FaceColor',colorname,'EdgeColor',colorname);               % Plot histogram
% hhh = findobj(gca,'Type','patch');
% set(hhh,'FaceColor',colorname,'EdgeColor',colorname)