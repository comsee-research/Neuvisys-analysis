...
from events.analysis.event_analysis import (
    quantity_variation
)
...
# %% variation of events over time

events = load_aedat4("/home/thomas/dvSave-2021_10_13_14_37_05.aedat4")
binsize = 10000 #µs
nb_events = quantity_variation(events, binsize)
nb_events = nb_events[nb_events > 5]
plt.figure()
plt.title("Variation of the number of events over time", fontsize=18)
plt.xlabel("time bin of " + str(binsize) + " (µs)", fontsize=16)
